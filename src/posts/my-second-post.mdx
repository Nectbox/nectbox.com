...
htmlTitle: What is the <mark>Jamstack?</mark>
...
slug: my-second-post
date: 2021-02-22
excerpt: Jamstack is a frontend architecture, an acronym that stands for Javascript, APIs, and Markup stack. In this architecture, markup that incorporates Javascript, is pre-built into static assets, served to a client from a CDN, and relies on reusable APIs for its functionalities.
category: business
keywords:
  - testing
  - context
