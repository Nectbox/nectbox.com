...
const PrivacyPage = ({ location }: PageProps) => {
  ...
  return (
    <DefaultLayout headerProps={{ heroCtaRef: ctaRef }}>
      <SEO pathname={location.pathname} title='Privacy Policy' />
      <Section caption='legal' title='Privacy Policy'>
        <Flex direction='column'>
          <BigHeading>Key note</BigHeading>
          <NormalText>
            Your privacy is important to us. It is Nectbox&#39;s policy to
            ...
            <Link to='https://nectbox.com/' isExternal>
              https://nectbox.com/
            </Link>
            , and other sites we own and operate.{' '}
          </NormalText>
          <NormalText>
            This policy is effective as of 3 March 2021 and was last updated on
            3 March 2021.{' '}
          </NormalText>
          <NormalHeading>Information We Collect</NormalHeading>
          <NormalText>
          ...
          <NormalHeading>Log Data</NormalHeading>
          <NormalText>
          ...
          <NormalHeading>Personal Information</NormalHeading>
          <NormalText>
          ...
          <List>
            ...
            <ListItem>Home/mailing address</ListItem>
          </List>
          <NormalHeading>
          ...
          <NormalHeading>Collection and Use of Information</NormalHeading>
          <NormalText>
          ...
          <NormalHeading>Security of Your Personal Information</NormalHeading>
          <NormalText>
          ...
          <BigHeading>Children’s Privacy</BigHeading>
          <NormalText>
          ...
          <BigHeading>Use of Cookies</BigHeading>
          <NormalText>
          ...
          <BigHeading>Limits of Our Policy</BigHeading>
          <NormalText>
          ...
          <BigHeading>Changes to This Policy</BigHeading>
          <NormalText>
          ...
          <List>
            <ListItem>
              <Link to='mailto:contact@nectbox.com' isExternal>
                contact@nectbox.com
              </Link>
            </ListItem>
            <ListItem>
              <Link to='/contact'>https://nectbox.com/contact</Link>
            </ListItem>
          </List>
        </Flex>
      </Section>
