...
<template preview>
  <div
    class="w-full h-48 bg-fixed bg-contain bg-center overflow-y-scroll"
    style="background-image:url('/img/placeholder-light-blue.svg');"
  >
    <div class="h-64"></div>
  </div>
</template>
...
<template preview>
  <div
    class="w-full h-72 bg-local bg-cover bg-center overflow-y-scroll"
    style="background-image:url('/img/placeholder-indigo.svg');"
  >
    <div class="h-96"></div>
  </div>
</template>
...
<template preview>
  <div
    class="w-full h-72 bg-scroll bg-cover overflow-y-scroll"
    style="background-image:url('/img/placeholder-fuchsia.svg');"
  >
    <div class="h-96"></div>
  </div>
</template>
